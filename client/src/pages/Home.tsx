...
import { type Message as LecturerMessage } from "@/components/AIChatBox";
import { DeferredFacultyChat } from "@/components/DeferredFacultyChat";
...
export default function Home() {
  ...
  return <div className="min-h-screen overflow-x-hidden bg-[#061018] text-[#eff4f1] selection:bg-[#e49aa9] selection:text-[#061018]">
    ...
    <footer className="border-t border-white/10 bg-[#030b11] px-5 py-8 sm:px-8 lg:px-12"><div className="mx-auto flex max-w-[1600px] flex-col justify-between gap-4 text-[10px] font-bold uppercase tracking-[.15em] text-[#9db1ae] sm:flex-row sm:items-center"><div className="flex items-center gap-3"><img src={wordmark} alt="fleshsesh | academy" className="h-12 w-[200px] max-w-full object-cover object-center" /><span>adult learning with agency</span></div><div className="flex gap-5"><button onClick={() => showNotice("The learner agreement will be available in the member learning space.")} className="transition hover:text-[#e6c887]">Learner agreement</button><button onClick={resetAgeGate} className="transition hover:text-[#e6c887]">Age access</button></div></div></footer>
